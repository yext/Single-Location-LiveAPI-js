...
// API Call
 $(document).ready(function () {
  ...
  $.ajax({
    type: 'GET',
    url : 'https://liveapi.yext.com/v2/accounts/me/locations/' + locationID + '?api_key=' + api_key + '&v=' + vParam,
...
// This format is US specific, feel free to replace with your preferred format
